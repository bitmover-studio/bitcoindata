            ...
            <div class="container">
                <div class="row grid gap-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <p class="fw-semibold"><a href="https://bitcointalk.org/index.php?topic=5445282.0" class='footer-link'
                                title="bitcointalk ANN" target="_blank" rel="noreferrer">bitcointalk.org</a></p>
                        <p class="fw-semibold"><a href="https://github.com/bitmover-studio/bitcoindata" class='footer-link'
                                title="GitHub Repository" target="_blank" rel="noreferrer">GitHub</a></p>
                        <p class="fw-semibold"><a href="https://www.altcoinstalks.com/index.php?topic=322524.0"
                                class='footer-link' title="altcoinstalks ANN" target="_blank" rel="noreferrer">Altcoinstalks</a>
                        </p>
                    </div>
                    <div class="col-md-3">
                        <p class="text-muted">Sponsor</p>
                        <a href="https://www.l0tt0.com/?utm_source=bitcoindata.science" target="_blank" referrer=noopener noreferrer title="Retro Crypto Casino" 
                            alt="Retro Crypto Casino">
                            <p class="footer-link fw-semibold mb-2">Retro Crypto Casino</p>
                            <img src="https://bitcoindata.science/img/lotto-logo.svg" title="Retro Crypto Casino"
                                alt="l0tt0.com" height="35" width="99" class="p-2 bg-l0tt0 rounded"
                                style="background-color: #FBE24B;" />
                        </a>
                    </div>
                </div>
            </div>
