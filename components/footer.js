    ...
    <div class="container-fluid col-lg-12 col-xl-9 ">
        <div class="row grid gap-3">
            <div class="col-md">
                ...
                <a href="donate" class="btn btn-danger rounded-pill btn-lg mt-3 px-5 text-decoration-none">
            ...
            <div class="col-md-3">
                ...
                <a href="https://www.l0tt0.com/?utm_source=bitcoindata.science" class="footer-link text-decoration-none" target="_blank" referrer=noopener noreferrer title="Retro Crypto Casino" alt="Retro Crypto Casino">
                    ...
                    <img src="/img/lotto-logo.svg" title="Retro Crypto Casino" alt="l0tt0.com" height="35" class="p-2 bg-l0tt0 rounded-pill px-4" style="background-color: #FBE24B;" />
                </a>
            </div>
        </div>
    </div>
