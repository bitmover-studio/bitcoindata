...
<nav id="topnav" class="navbar navbar-expand-lg bg-body-tertiary border-bottom border-1 py-0">
    <div class="container-fluid col-xl-9 px-2 my-0">
    ...
    .join("")}
        ...
        <span class="d-flex align-items-center d-xl-flex mb-2">
            <div id="nav-theme-toggler" class="rounded-4 bg-body-tertiary nav-icon-btn d-flex justify-content-center align-items-center" style="width: 60px; height: 60px; overflow: hidden;">
              ...
              <button type="button" class="navbar-toggler d-xl-none d-block border-0 m-2 p-0 rounded-4 bg-body-tertiary nav-icon-btn d-flex justify-content-center align-items-center" style="width: 60px; height: 60px;" data-bs-toggle="modal" data-bs-target="#MenuMobile">
