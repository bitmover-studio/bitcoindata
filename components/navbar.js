...
<nav id="topnav" class="navbar navbar-expand-lg">
    ...
    .join("")}
        ...
        <span class="d-flex align-items-center d-xl-flex">
            <div id="nav-theme-toggler" class="rounded-circle bg-body-tertiary nav-icon-btn d-flex justify-content-center align-items-center" style="width: 60px; height: 60px; overflow: hidden;">
